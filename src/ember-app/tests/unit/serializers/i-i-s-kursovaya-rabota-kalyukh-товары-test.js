...
moduleForModel('i-i-s-kursovaya-rabota-kalyukh-товары', 'Unit | Serializer | i-i-s-kursovaya-rabota-kalyukh-товары', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-kalyukh-товары',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
