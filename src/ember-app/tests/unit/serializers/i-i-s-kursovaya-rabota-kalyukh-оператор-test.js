...
moduleForModel('i-i-s-kursovaya-rabota-kalyukh-оператор', 'Unit | Serializer | i-i-s-kursovaya-rabota-kalyukh-оператор', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-kalyukh-оператор',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
