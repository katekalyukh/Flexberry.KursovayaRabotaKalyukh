...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota kalyukh проверка киоска l');

test('testing i-i-s-kursovaya-rabota-kalyukh-проверка-киоска-l', function(assert) {
